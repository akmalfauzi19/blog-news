...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Article/</span> Edit</h4>
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" class="add-new pt-0 row g-2" id="form-article"
                        ...
                        @csrf
                        @method('PUT')
                        <input type="text" name="" id="id" value="{{ $article->id }}" hidden>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-1 input-group" id="select2-ajax-category2">
                                <select class="select2-data-ajax form-control dt-roles" name="category_id"
                        ...
                        <div class="mb-3">
                            ...
                            <span style="color: red; font-size: 10px;">*Kosongkan jika tidak ingin diubah</span>
                        </div>
